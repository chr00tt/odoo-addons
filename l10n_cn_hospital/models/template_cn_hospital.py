...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_cn_hospital_template_data(self):
        ...
        return {
            ...
            'property_account_payable_id': 'account_template_hospital_2302',
    ...
    def _get_cn_hospital_res_company(self):
        ...
        return {
            self.env.company.id: {
                ...
                'income_currency_exchange_account_id': 'account_template_hospital_1902',
                'expense_currency_exchange_account_id': 'account_template_hospital_1902',
