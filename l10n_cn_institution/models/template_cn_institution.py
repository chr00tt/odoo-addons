...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_cn_institution_template_data(self):
        ...
        return {
            'name': '政府会计制度 - 行政事业单位',
            'code_digits': '4',
            'property_account_receivable_id': 'account_template_institution_1212',
            'property_account_payable_id': 'account_template_institution_2302',
            'property_account_expense_categ_id': 'account_template_institution_5201',
            'property_account_income_categ_id': 'account_template_institution_4401',
            'property_stock_account_input_categ_id': 'account_template_institution_1301',
            'property_stock_account_output_categ_id': 'account_template_institution_1303',
            'property_stock_valuation_account_id': 'account_template_institution_1302',
    ...
    def _get_cn_institution_res_company(self):
        ...
        return {
            self.env.company.id: {
                ...
                'bank_account_code_prefix': '10020',
                'cash_account_code_prefix': '10010',
                'transfer_account_code_prefix': '10030',
                'account_default_pos_receivable_account_id': 'account_template_institution_1212',
                'income_currency_exchange_account_id': 'account_template_institution_1902',
                'expense_currency_exchange_account_id': 'account_template_institution_1902',
