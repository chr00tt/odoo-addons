        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            queries.append(f'''
                ...
                SELECT
                    ...
                    move_account_account_tag.account_account_tag_id AS account_tag_id,
                ...
                LEFT JOIN move_account_account_tag
                    ON move_account_account_tag.account_move_line_id = account_move_line.id
                    AND move_account_account_tag.account_account_tag_id IN %s
                ...
                GROUP BY account_move_line.company_id, account_move_line.account_id, account_account.code, {account_name}, account_account.account_type, move_account_account_tag.account_account_tag_id
                ...
                WHERE account_move_line.move_id IN (SELECT unnest(payment_move_ids.move_id) FROM payment_move_ids)
                    AND account_move_line.account_id NOT IN %s
                GROUP BY account_move_line.account_id, account_account.code, {account_name}, account_account.account_type, move_account_account_tag.account_account_tag_id)
            ''')
        ...
        for column in options['columns']:
            queries.append(f'''
                ...
                LEFT JOIN move_account_account_tag
                    ...
                    AND move_account_account_tag.account_account_tag_id IN %s
                WHERE account_move_line.move_id IN %s
                GROUP BY account_move_line.move_id, account_move_line.account_id, account_account.code, {account_name}, account_account.account_type, move_account_account_tag.account_account_tag_id
            ''')
