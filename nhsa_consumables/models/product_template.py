...
class ProductTemplate(models.Model):
    ...
    nhsa_consumables_id = fields.Many2one(
        'nhsa.consumables', '医保代码',
        required=True)

    nhsa_consumables_categ_id = fields.Many2one(related='nhsa_consumables_id.nhsa_consumables_categ_id')
