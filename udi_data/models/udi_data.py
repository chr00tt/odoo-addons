...
class UDIData(models.Model):
    ...
    lot_or_batch_number = fields.Boolean("生产标识是否包含批号")
    serial_number = fields.Boolean("生产标识是否包含序列号")
    scbssfbhscrq = fields.Boolean("生产标识是否包含生产日期")
    scbssfbhsxrq = fields.Boolean("生产标识是否包含失效日期")
